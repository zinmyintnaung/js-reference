...
const ItemCtrl = (function(){
    ...
    const data = {
        ...
        currentItem: null, //this variable is to use when update specific item
        totalCalories: 0
    }
    ...
    return {
        ...
        updateItem: function(name, calories){
            ...
            calories = parseInt(calories);
            let found = null;
            // Loop items to update a desired item
            data.items.forEach(function(item){
...
const App = (function(ItemCtrl, UICtrl){
    ...
    const loadEventListeners = function(){
        ...
        // Disable form submit on pressing Enter key on keyboard
